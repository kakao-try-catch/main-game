...
import { FlappyBirdData, FlappyPipeData, FlappyRopeData, PlayerData, ReportCard } from './common-type';
...
export type SystemPacket = UpdateNumberPacket | JoinRoomPacket | RoomUpdatePacket | SystemMessagePacket | GameConfigUpdateReqPacket | GameConfigUpdatePacket | GameStartReqPacket | ReadyScenePacket | UpdateScorePacket | ReturnToTheLobbyReqPacket | ReturnToTheLobbyPacket | ReplayReqPacket | SetTimePacket | TimeEndPacket;
export declare enum AppleGamePacketType {
...
export type AppleGamePacket = SetFieldPacket | UpdateDragAreaPacket | DropCellIndexPacket | ConfirmDragAreaPacket | DrawingDragAreaPacket;
export declare enum FlappyBirdPacketType {
...
export type FlappyBirdPacket = FlappyJumpPacket | FlappyWorldStatePacket | FlappyScoreUpdatePacket | FlappyGameOverPacket;
