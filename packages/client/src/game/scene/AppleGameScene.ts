...
export default class AppleGameScene extends Phaser.Scene {
	...
	editorCreate(): void {
		...
		// row_0
		const row_0 = this.add.container(91, 91);

		// rectangle_1
		const rectangle_1 = new applePrefab(this, 0, 0);
		row_0.add(rectangle_1);
		...
		this._editabletilemap = editabletilemap;
		this._list = list;
		// mark as used to satisfy noUnused rules
		void this._editabletilemap;
		void this._list;

		this.events.emit("scene-awake");
	}

	private _editabletilemap!: Phaser.Tilemaps.Tilemap;
